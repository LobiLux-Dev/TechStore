/*
  ...
  - You are about to drop the `_ProductToProvider` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "_ProductToProvider" DROP CONSTRAINT "_ProductToProvider_A_fkey";

-- DropForeignKey
ALTER TABLE "_ProductToProvider" DROP CONSTRAINT "_ProductToProvider_B_fkey";
